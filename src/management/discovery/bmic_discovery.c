...
static bool bmic_try_init(
	bmic_api_interface_t *api, bmic_handle_t **outhandle, bmic_discovery_pair_t *pair) {
...
static bmic_api_interface_t *bmic_discovery_registry_initializer(
	const gru_list_t *list, bmic_handle_t **outhandle, bmic_discovery_pair_t *pair) {

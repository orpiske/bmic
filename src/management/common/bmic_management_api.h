...
typedef bmic_handle_t *(*bmic_management_api_init_fn)(
...
typedef bmic_product_info_t *(*bmic_management_api_info_fn)(
	bmic_handle_t *handle, const bmic_exchange_t *capabilities, gru_status_t *status);
typedef const bmic_exchange_t *(*bmic_management_api_cap_fn)(
...
typedef const bmic_exchange_t *(*bmic_management_api_queue_attribute_read_fn)(
	bmic_handle_t *handle, const bmic_exchange_t *capabilities, const char *name,
	gru_status_t *status, const char *queue);

typedef const bmic_list_t *(*bmic_management_api_attr_list_fn)(
	bmic_handle_t *handle, const bmic_exchange_t *cap, gru_status_t *status);
typedef const bmic_list_t *(*bmic_management_api_op_list_fn)(
	bmic_handle_t *handle, const bmic_exchange_t *cap, gru_status_t *status);
...
typedef const bmic_list_t *(*bmic_management_api_queue_list_fn)(
	bmic_handle_t *handle, const bmic_exchange_t *cap, gru_status_t *status);
...
typedef bmic_topic_stat_t (*bmic_management_api_topic_stats_fn)(bmic_handle_t *handle,
	const bmic_exchange_t *cap, const char *name, gru_status_t *status);
